...
function Opstmt() {
  ...
  const[NeCaAcc1, setNeCaAcc1] = useState("");
  const[NeCaAcc2, setNeCaAcc2] = useState("");
  const[NeCaAcc3, setNeCaAcc3] = useState("");
  const[NeCaAcc4, setNeCaAcc4] = useState("");
  const[NeCaAcc5, setNeCaAcc5] = useState("");
  const[NeCaAcc6, setNeCaAcc6] = useState("");
  const[NeCaAcc7, setNeCaAcc7] = useState("");
  const[NeCaAcc8, setNeCaAcc8] = useState("");

  useEffect(() => {
    localStorage.setItem("NeCaAcc1", NeCaAcc1);
  }, [NeCaAcc1]);

  
useEffect(() => {
  localStorage.setItem("NeCaAcc2", NeCaAcc2);
}, [NeCaAcc2]);


useEffect(() => {
  localStorage.setItem("NeCaAcc3", NeCaAcc3);
}, [NeCaAcc3]);


useEffect(() => {
  localStorage.setItem("NeCaAcc4", NeCaAcc4);
}, [NeCaAcc4]);


useEffect(() => {
  localStorage.setItem("NeCaAcc5", NeCaAcc5);
}, [NeCaAcc5]);



useEffect(() => {
  localStorage.setItem("NeCaAcc6", NeCaAcc6);
}, [NeCaAcc6]);


useEffect(() => {
  localStorage.setItem("NeCaAcc7", NeCaAcc7);
}, [NeCaAcc7]);


useEffect(() => {
  localStorage.setItem("NeCaAcc8", NeCaAcc8);
}, [NeCaAcc8]);
  ...
  useEffect(() => {
    localStorage.setItem("ReMa1", ReMa1);
  }, [ReMa1]);
  
  

useEffect(() => {
  localStorage.setItem("ReMa2", ReMa2);
}, [ReMa2]);



useEffect(() => {
  localStorage.setItem("ReMa3", ReMa3);
}, [ReMa3]);



useEffect(() => {
  localStorage.setItem("ReMa4", ReMa4);
}, [ReMa4]);



useEffect(() => {
  localStorage.setItem("ReMa5", ReMa5);
}, [ReMa5]);



useEffect(() => {
  localStorage.setItem("ReMa6", ReMa6);
}, [ReMa6]);



useEffect(() => {
  localStorage.setItem("ReMa7", ReMa7);
}, [ReMa7]);



useEffect(() => {
  localStorage.setItem("ReMa8", ReMa8);
}, [ReMa8]);
  ...
  const costsales1Sum = () => {
    try {
      const sales1Sum = eval(
        `(${dePre1 || 0} + ${finGo1 || 0} + ${wrkPo1 || 0} + ${raMat1 || 0} +  ${PuRm1 || 0}  +
  ...
  const costsales2Sum = () => {
    try {
      const sales2Sum = eval(
        `(${dePre2 || 0} + ${FiGood12 || 0} + ${wrkPo12 || 0} + ${raMat12 || 0}  +  ${PuRm2 || 0} +
  ...
  const costsales3Sum = () => {
    try {
      const sales3Sum = eval(
        `(${dePre3 || 0} + ${FiGood13 || 0} + ${wrkPo13 || 0} + ${raMat13 || 0}  +  ${PuRm3 || 0} +
  ...
  const costsales4Sum = () => {
    try {
      const sales4Sum = eval(
        `(${dePre4 || 0} + ${FiGood14 || 0} + ${wrkPo14 || 0} + ${raMat14 || 0}  +  ${PuRm4 || 0} +
  ...
  const costsales5Sum = () => {
    try {
      const sales5Sum = eval(
        `(${dePre5 || 0} + ${FiGood15 || 0} + ${wrkPo15 || 0} + ${raMat15 || 0}   +  ${PuRm5 || 0} +
  ...
  const costsales6Sum = () => {
    try {
      const sales6Sum = eval(
        `(${dePre6 || 0} + ${FiGood16 || 0} + ${wrkPo16 || 0} + ${raMat16 || 0}  +  ${PuRm6 || 0} +
  ...
  const costsales7Sum = () => {
    try {
      const sales7Sum = eval(
        `(${dePre7 || 0} + ${FiGood17 || 0} + ${wrkPo17 || 0} + ${raMat17 || 0}  +  ${PuRm7 || 0} +
  ...
  const costsales8Sum = () => {
    try {
      const sales8Sum = eval(
        `(${dePre8 || 0} + ${FiGood18 || 0} + ${wrkPo18 || 0} + ${raMat18 || 0}  +  ${PuRm8 || 0} +
  ...
  const costprod1Sum = () => {  //amal
    try {
      const prod1Sum = eval(
        `(${dePre1 || 0} +  ${wrkPo1 || 0} + ${raMat1 || 0} +
         ${pwFu1 || 0} + ${drLa1 || 0} + ${ReMa1 || 0} + ${mfDiEx1 || 0} + ${PuRm1 || 0}  ) - 
         ( ${wrkPo12 || 0} + ${raMat12 || 0} )`
      );
  ...
  useEffect(() => {
    costprod1Sum();
  }, [dePre1, wrkPo1, raMat1, pwFu1, drLa1, ReMa1, mfDiEx1, wrkPo12, raMat12 , PuRm1]);
    ...
    try {
      const prod2Sum = eval(
        `(${dePre2 || 0} +  ${wrkPo12 || 0} + ${raMat12 || 0} +
         ${pwFu2 || 0} + ${drLa2 || 0} + ${ReMa2 || 0} + ${mfDiEx2 || 0} + ${PuRm2 || 0}) - 
         ( ${wrkPo13 || 0} + ${raMat13 || 0} )`
      );
  ...
  useEffect(() => {
    costprod2Sum();
  }, [dePre2, wrkPo12, raMat12, pwFu2, drLa2, ReMa2,PuRm2, mfDiEx2, wrkPo13, raMat13]);
  ...
  const costprod3Sum = () => {
    try {
      const prod3Sum = eval(
        `(${dePre3 || 0} +  ${wrkPo13 || 0} + ${raMat13 || 0} + ${PuRm3 || 0} +
         ${pwFu3 || 0} + ${drLa3 || 0} + ${ReMa3 || 0} + ${mfDiEx3 || 0}) - 
         ( ${wrkPo14 || 0} + ${raMat14 || 0} )`
      );
  ...
  useEffect(() => {
    costprod3Sum();
  }, [dePre3, wrkPo13, raMat13, pwFu3, drLa3,PuRm3, ReMa3, mfDiEx3, wrkPo14, raMat14]);
  ...
  const costprod4Sum = () => {
    try {
      const prod4Sum = eval(
        `(${dePre4 || 0} +  ${wrkPo14 || 0} + ${raMat14 || 0} + ${PuRm4 || 0} +
         ${pwFu4 || 0} + ${drLa4 || 0} + ${ReMa4 || 0} + ${mfDiEx4 || 0}) - 
         ( ${wrkPo15 || 0} + ${raMat15 || 0} )`
      );
  ...
  useEffect(() => {
    costprod4Sum();
  }, [dePre4, wrkPo14, raMat14, pwFu4, drLa4,PuRm4, ReMa4, mfDiEx4, wrkPo15, raMat15]);
  ...
  const costprod5Sum = () => {
    try {
      const prod5Sum = eval(
        `(${dePre5 || 0} +  ${wrkPo15 || 0} + ${raMat15 || 0} + ${PuRm5 || 0} +
         ${pwFu5 || 0} + ${drLa5 || 0} + ${ReMa5 || 0} + ${mfDiEx5 || 0}) - 
         ( ${wrkPo16 || 0} + ${raMat16 || 0} )`
      );
  ...
  useEffect(() => {
    costprod5Sum();
  }, [dePre5, wrkPo15, raMat15, pwFu5, drLa5,PuRm5, ReMa5, mfDiEx5, wrkPo16, raMat16]);
  ...
  const costprod6Sum = () => {
    try {
      const prod6Sum = eval(
        `(${dePre6 || 0} +  ${wrkPo16 || 0} + ${raMat16 || 0} + ${PuRm6 || 0} +
         ${pwFu6 || 0} + ${drLa6 || 0} + ${ReMa6 || 0} + ${mfDiEx6 || 0}) - 
         ( ${wrkPo17 || 0} + ${raMat17 || 0} )`
      );
  ...
  useEffect(() => {
    costprod6Sum();
  }, [dePre6, wrkPo16, raMat16, pwFu6,PuRm6, drLa6, ReMa6, mfDiEx6, wrkPo17, raMat17]);
  ...
  const costprod7Sum = () => {
    try {
      const prod7Sum = eval(
        `(${dePre7 || 0} +  ${wrkPo17 || 0} + ${raMat17 || 0} + ${PuRm7 || 0} +
         ${pwFu7 || 0} + ${drLa7 || 0} + ${ReMa7 || 0} + ${mfDiEx7 || 0}) - 
         ( ${wrkPo18 || 0} + ${raMat18 || 0} )`
      );
  ...
  useEffect(() => {
    costprod7Sum();
  }, [dePre7, wrkPo17, raMat17, pwFu7, drLa7, ReMa7, mfDiEx7, wrkPo18,PuRm7, raMat18]);
  ...
  const costprod8Sum = () => {
    try {
      const prod8Sum = eval(
        `(${dePre8 || 0} +  ${wrkPo18 || 0} + ${raMat18 || 0} + ${PuRm8 || 0} +
         ${pwFu8 || 0} + ${drLa8 || 0} + ${ReMa8 || 0} + ${mfDiEx8 || 0}) - 
         ( ${wrkPo19 || 0} + ${raMat19 || 0} )`
      );
  ...
  useEffect(() => {
    costprod8Sum();
  }, [dePre8, wrkPo18, raMat18, pwFu8, drLa8, ReMa8, mfDiEx8, wrkPo19,PuRm8, raMat19]);
  ...
  useEffect(() => {
    localStorage.setItem("IntFinch", IntFinch);
  }, [IntFinch]);

  useEffect(() => {
    localStorage.setItem("IntFinch2", IntFinch2);
  }, [IntFinch2]);

  useEffect(() => {
    localStorage.setItem("IntFinch3", IntFinch3);
  }, [IntFinch3]);
  
  useEffect(() => {
    localStorage.setItem("IntFinch4", IntFinch4);
  }, [IntFinch4]);
  
  useEffect(() => {
    localStorage.setItem("IntFinch5", IntFinch5);
  }, [IntFinch5]);
  
  useEffect(() => {
    localStorage.setItem("IntFinch6", IntFinch6);
  }, [IntFinch6]);
  
  useEffect(() => {
    localStorage.setItem("IntFinch7", IntFinch7);
  }, [IntFinch7]);
  
  useEffect(() => {
    localStorage.setItem("IntFinch8", IntFinch8);
  }, [IntFinch8]);
  ...
  useEffect(() => {
    localStorage.setItem("divDra1", divDra1);
  }, [divDra1]);
  useEffect(() => {
    localStorage.setItem("divDra2", divDra2);
  }, [divDra2]);
  
  useEffect(() => {
    localStorage.setItem("divDra3", divDra3);
  }, [divDra3]);
  
  useEffect(() => {
    localStorage.setItem("divDra4", divDra4);
  }, [divDra4]);
  
  useEffect(() => {
    localStorage.setItem("divDra5", divDra5);
  }, [divDra5]);
  
  useEffect(() => {
    localStorage.setItem("divDra6", divDra6);
  }, [divDra6]);
  
  useEffect(() => {
    localStorage.setItem("divDra7", divDra7);
  }, [divDra7]);
  
  useEffect(() => {
    localStorage.setItem("divDra8", divDra8);
  }, [divDra8]);
...
useEffect(() => {
  localStorage.setItem("costprod1", costprod1);
}, [costprod1]);


useEffect(() => {
localStorage.setItem("costprod2", costprod2);
}, [costprod2]);


useEffect(() => {
localStorage.setItem("costprod3", costprod3);
}, [costprod3]);


useEffect(() => {
localStorage.setItem("costprod4", costprod4);
}, [costprod4]);


useEffect(() => {
localStorage.setItem("costprod5", costprod5);
}, [costprod5]);


useEffect(() => {
localStorage.setItem("costprod6", costprod6);
}, [costprod6]);


useEffect(() => {
localStorage.setItem("costprod7", costprod7);
}, [costprod7]);


useEffect(() => {
localStorage.setItem("costprod8", costprod8);
}, [costprod8]);
...
useEffect(() => {
  localStorage.setItem("costsales1", costsales1);
  }, [costsales1]);

  useEffect(() => {
    localStorage.setItem("costsales2", costsales2);
    }, [costsales2]);

    useEffect(() => {
      localStorage.setItem("costsales3", costsales3);
    }, [costsales3]);
    
    useEffect(() => {
      localStorage.setItem("costsales4", costsales4);
    }, [costsales4]);
    
    useEffect(() => {
      localStorage.setItem("costsales5", costsales5);
    }, [costsales5]);
    
    useEffect(() => {
      localStorage.setItem("costsales6", costsales6);
    }, [costsales6]);
    
    useEffect(() => {
      localStorage.setItem("costsales7", costsales7);
    }, [costsales7]);
    useEffect(() => {
      localStorage.setItem("costsales8", costsales8);
    }, [costsales8]);
  ...
  useEffect(() => {
    localStorage.setItem("finGo1", finGo1);
  }, [finGo1]);
  
  useEffect(() => {
    localStorage.setItem("wrkPo1", wrkPo1);
  }, [wrkPo1]);



  useEffect(() => {
    localStorage.setItem("dePre1", dePre1);
  }, [dePre1]);

  useEffect(() => {
    localStorage.setItem("dePre2", dePre2);
  }, [dePre2]);
  
  useEffect(() => {
    localStorage.setItem("dePre3", dePre3);
  }, [dePre3]);
  
  
  useEffect(() => {
    localStorage.setItem("dePre4", dePre4);
  }, [dePre4]);
  
  useEffect(() => {
    localStorage.setItem("dePre5", dePre5);
  }, [dePre5]);
  
  useEffect(() => {
    localStorage.setItem("dePre6", dePre6);
  }, [dePre6]);
  
  useEffect(() => {
    localStorage.setItem("dePre7", dePre7);
  }, [dePre7]);
  
  useEffect(() => {
    localStorage.setItem("dePre8", dePre8);
  }, [dePre8]);
  ...
  useEffect(() => {
    localStorage.setItem("NePrafTa1", NePrafTa1);
  }, [NePrafTa1]);

  useEffect(() => {
    localStorage.setItem("NePrafTa2", NePrafTa2);
  }, [NePrafTa2]);
  
  useEffect(() => {
    localStorage.setItem("NePrafTa3", NePrafTa3);
  }, [NePrafTa3]);
  
  useEffect(() => {
    localStorage.setItem("NePrafTa4", NePrafTa4);
  }, [NePrafTa4]);
  
  useEffect(() => {
    localStorage.setItem("NePrafTa5", NePrafTa5);
  }, [NePrafTa5]);
  
  useEffect(() => {
    localStorage.setItem("NePrafTa6", NePrafTa6);
  }, [NePrafTa6]);
  
  useEffect(() => {
    localStorage.setItem("NePrafTa7", NePrafTa7);
  }, [NePrafTa7]);
  
  useEffect(() => {
    localStorage.setItem("NePrafTa8", NePrafTa8);
  }, [NePrafTa8]);
  ...
  useEffect(() => {
    localStorage.setItem("opProLo1", opProLo1);
  }, [opProLo1]);

  
useEffect(() => {
  localStorage.setItem("opProLo2", opProLo2);
}, [opProLo2]);


useEffect(() => {
  localStorage.setItem("opProLo3", opProLo3);
}, [opProLo3]);


useEffect(() => {
  localStorage.setItem("opProLo4", opProLo4);
}, [opProLo4]);



useEffect(() => {
  localStorage.setItem("opProLo5", opProLo5);
}, [opProLo5]);


useEffect(() => {
  localStorage.setItem("opProLo6", opProLo6);
}, [opProLo6]);


useEffect(() => {
  localStorage.setItem("opProLo7", opProLo7);
}, [opProLo7]);


useEffect(() => {
  localStorage.setItem("opProLo8", opProLo8);
}, [opProLo8]);


useEffect(() => {
  localStorage.setItem("mfDiEx1", mfDiEx1);
}, [mfDiEx1]);

useEffect(() => {
  localStorage.setItem("mfDiEx2", mfDiEx2);
}, [mfDiEx2]);

useEffect(() => {
  localStorage.setItem("mfDiEx3", mfDiEx3);
}, [mfDiEx3]);

useEffect(() => {
  localStorage.setItem("mfDiEx4", mfDiEx4);
}, [mfDiEx4]);


useEffect(() => {
  localStorage.setItem("mfDiEx5", mfDiEx5);
}, [mfDiEx5]);

useEffect(() => {
  localStorage.setItem("mfDiEx6", mfDiEx6);
}, [mfDiEx6]);

useEffect(() => {
  localStorage.setItem("mfDiEx7", mfDiEx7);
}, [mfDiEx7]);

useEffect(() => {
  localStorage.setItem("mfDiEx8", mfDiEx8);
}, [mfDiEx8]);


useEffect(() => {
  localStorage.setItem("selAdm1", selAdm1);
}, [selAdm1]);

useEffect(() => {
  localStorage.setItem("selAdm2", selAdm2);
}, [selAdm2]);

useEffect(() => {
  localStorage.setItem("selAdm3", selAdm3);
}, [selAdm3]);

useEffect(() => {
  localStorage.setItem("selAdm4", selAdm4);
}, [selAdm4]);

useEffect(() => {
  localStorage.setItem("selAdm5", selAdm5);
}, [selAdm5]);

useEffect(() => {
  localStorage.setItem("selAdm6", selAdm6);
}, [selAdm6]);

useEffect(() => {
  localStorage.setItem("selAdm7", selAdm7);
}, [selAdm7]);

useEffect(() => {
  localStorage.setItem("selAdm8", selAdm8);
}, [selAdm8]);



useEffect(() => {
  localStorage.setItem("pBdiT1", pBdiT1);
}, [pBdiT1]);

useEffect(() => {
  localStorage.setItem("pBdiT2", pBdiT2);
}, [pBdiT2]);

useEffect(() => {
  localStorage.setItem("pBdiT3", pBdiT3);
}, [pBdiT3]);

useEffect(() => {
  localStorage.setItem("pBdiT4", pBdiT4);
}, [pBdiT4]);

useEffect(() => {
  localStorage.setItem("pBdiT5", pBdiT5);
}, [pBdiT5]);

useEffect(() => {
  localStorage.setItem("pBdiT6", pBdiT6);
}, [pBdiT6]);

useEffect(() => {
  localStorage.setItem("pBdiT7", pBdiT7);
}, [pBdiT7]);

useEffect(() => {
  localStorage.setItem("pBdiT8", pBdiT8);
}, [pBdiT8]);
...
const sumNeCaAcc1 = () => {
  try {
    ...
    const result = eval(`  (${CasAcc1 || 0} - ${divDra1 || 0}) `);
    setNeCaAcc1(result);
  } catch (error) {
    setNeCaAcc1("Input all ");  
  }
};
...
const sumNeCaAcc2 = () => {
  try {
    ...
    const result = eval(`  (${CasAcc2 || 0} - ${divDra2 || 0}) `);
    setNeCaAcc2(result);
  } catch (error) {
    setNeCaAcc2("Input all ");  
  }
};
...
const sumNeCaAcc3 = () => {
  try {
    ...
    const result = eval(`  (${CasAcc3 || 0} - ${divDra3 || 0}) `);
    setNeCaAcc3(result);
  } catch (error) {
    setNeCaAcc3("Input all ");  
  }
};
...
const sumNeCaAcc4 = () => {
  try {
    ...
    const result = eval(`  (${CasAcc4 || 0} - ${divDra4 || 0}) `);
    setNeCaAcc4(result);
  } catch (error) {
    setNeCaAcc4("Input all ");  
  }
};
...
const sumNeCaAcc5 = () => {
  try {
    ...
    const result = eval(`  (${CasAcc5 || 0} - ${divDra5 || 0}) `);
    setNeCaAcc5(result);
  } catch (error) {
    setNeCaAcc5("Input all ");  
  }
};
...
const sumNeCaAcc6 = () => {
  try {
    ...
    const result = eval(`  (${CasAcc6 || 0} - ${divDra6 || 0}) `);
    setNeCaAcc6(result);
  } catch (error) {
    setNeCaAcc6("Input all ");  
  }
};
...
const sumNeCaAcc7 = () => {
  try {
    ...
    const result = eval(`  (${CasAcc7 || 0} - ${divDra7 || 0}) `);
    setNeCaAcc7(result);
  } catch (error) {
    setNeCaAcc7("Input all ");  
  }
};
...
const sumNeCaAcc8 = () => {
  try {
    ...
    const result = eval(`  (${CasAcc8 || 0} - ${divDra8 || 0}) `);
    setNeCaAcc8(result);
  } catch (error) {
    setNeCaAcc8("Input all ");  
  }
};
