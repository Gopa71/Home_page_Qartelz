...
function Assetliab  () {
  ...
  const FinishGo1 = localStorage.getItem('FiGood12');
  const FinishGo2 = localStorage.getItem('FiGood13');
  const FinishGo3 = localStorage.getItem('FiGood14');
  const FinishGo4 = localStorage.getItem('FiGood15');
  const FinishGo5 = localStorage.getItem('FiGood16');
  const FinishGo6 = localStorage.getItem('FiGood17');
  const FinishGo7 = localStorage.getItem('FiGood18');
  const FinishGo8 = localStorage.getItem('FiGood19');

  useEffect(() => {
    localStorage.setItem("FinishGo1", FinishGo1);
  }, [FinishGo1]);

  useEffect(() => {
    localStorage.setItem("FinishGo2", FinishGo2);
  }, [FinishGo2]);
  
  useEffect(() => {
    localStorage.setItem("FinishGo3", FinishGo3);
  }, [FinishGo3]);
  
  useEffect(() => {
    localStorage.setItem("FinishGo4", FinishGo4);
  }, [FinishGo4]);
  
  useEffect(() => {
    localStorage.setItem("FinishGo5", FinishGo5);
  }, [FinishGo5]);
  
  useEffect(() => {
    localStorage.setItem("FinishGo6", FinishGo6);
  }, [FinishGo6]);
  
  useEffect(() => {
    localStorage.setItem("FinishGo7", FinishGo7);
  }, [FinishGo7]);
  
  useEffect(() => {
    localStorage.setItem("FinishGo8", FinishGo8);
  }, [FinishGo8]);
  ...
  const stkInPr1 = localStorage.getItem('wrkPo12')
  const stkInPr2 = localStorage.getItem('wrkPo13')
  const stkInPr3 = localStorage.getItem('wrkPo14')
  const stkInPr4 = localStorage.getItem('wrkPo15')
  const stkInPr5 = localStorage.getItem('wrkPo16')
  const stkInPr6 = localStorage.getItem('wrkPo17')
  const stkInPr7 = localStorage.getItem('wrkPo18')
  const stkInPr8 = localStorage.getItem('wrkPo19')

  
  useEffect(() => {
    localStorage.setItem("stkInPr1", stkInPr1);
  }, [stkInPr1]);
  useEffect(() => {
    localStorage.setItem("stkInPr2", stkInPr2);
  }, [stkInPr2]);
  
  useEffect(() => {
    localStorage.setItem("stkInPr3", stkInPr3);
  }, [stkInPr3]);
  
  useEffect(() => {
    localStorage.setItem("stkInPr4", stkInPr4);
  }, [stkInPr4]);
  
  useEffect(() => {
    localStorage.setItem("stkInPr5", stkInPr5);
  }, [stkInPr5]);
  
  useEffect(() => {
    localStorage.setItem("stkInPr6", stkInPr6);
  }, [stkInPr6]);
  
  useEffect(() => {
    localStorage.setItem("stkInPr7", stkInPr7);
  }, [stkInPr7]);
  
  useEffect(() => {
    localStorage.setItem("stkInPr8", stkInPr8);
  }, [stkInPr8]);

  const raMa1 = localStorage.getItem('raMat12');
  const raMa2 = localStorage.getItem('raMat13');
  const raMa3 = localStorage.getItem('raMat14');
  const raMa4 = localStorage.getItem('raMat15');
  const raMa5 = localStorage.getItem('raMat16');
  const raMa6 = localStorage.getItem('raMat17');
  const raMa7 = localStorage.getItem('raMat18');
  const raMa8 = localStorage.getItem('raMat19');

  useEffect(() => {
    localStorage.setItem("raMa1", raMa1);
  }, [raMa1]);
  useEffect(() => {
    localStorage.setItem("raMa2", raMa2);
  }, [raMa2]);
  
  useEffect(() => {
    localStorage.setItem("raMa3", raMa3);
  }, [raMa3]);
  
  useEffect(() => {
    localStorage.setItem("raMa4", raMa4);
  }, [raMa4]);
  useEffect(() => {
    localStorage.setItem("raMa5", raMa5);
  }, [raMa5]);
  
  useEffect(() => {
    localStorage.setItem("raMa6", raMa6);
  }, [raMa6]);
  
  useEffect(() => {
    localStorage.setItem("raMa7", raMa7);
  }, [raMa7]);
  
  useEffect(() => {
    localStorage.setItem("raMa8", raMa8);
  }, [raMa8]);
...
useEffect(() => {
  localStorage.setItem("ToLib1", ToLib1);
}, [ToLib1]);

useEffect(() => {
  localStorage.setItem("ToLib2", ToLib2);
}, [ToLib2]);

useEffect(() => {
  localStorage.setItem("ToLib3", ToLib3);
}, [ToLib3]);

useEffect(() => {
  localStorage.setItem("ToLib4", ToLib4);
}, [ToLib4]);

useEffect(() => {
  localStorage.setItem("ToLib5", ToLib5);
}, [ToLib5]);

useEffect(() => {
  localStorage.setItem("ToLib6", ToLib6);
}, [ToLib6]);
useEffect(() => {
  localStorage.setItem("ToLib7", ToLib7);
}, [ToLib7]);
useEffect(() => {
  localStorage.setItem("ToLib8", ToLib8);
}, [ToLib8]);
  ...
  useEffect(() => {
    localStorage.setItem("ReSur1", ReSur1);
  }, [ReSur1]);
  
  useEffect(() => {
    localStorage.setItem("ReSur2", ReSur2);
  }, [ReSur2]);

    

  useEffect(() => {
    localStorage.setItem("ReSur3", ReSur3);
  }, [ReSur3]);

    

  useEffect(() => {
    localStorage.setItem("ReSur4", ReSur4);
  }, [ReSur4]);

    

  useEffect(() => {
    localStorage.setItem("ReSur5", ReSur5);
  }, [ReSur5]);

    

  useEffect(() => {
    localStorage.setItem("ReSur6", ReSur6);
  }, [ReSur6]);

    

  useEffect(() => {
    localStorage.setItem("ReSur7", ReSur7);
  }, [ReSur7]);

    

  useEffect(() => {
    localStorage.setItem("ReSur8", ReSur8);
  }, [ReSur8]);
  ...
  useEffect(() => {
    localStorage.setItem("PaUpCa1", PaUpCa1);
  }, [PaUpCa1]);

  useEffect(() => {
    localStorage.setItem("PaUpCa2", PaUpCa2);
  }, [PaUpCa2]);

  useEffect(() => {
    localStorage.setItem("PaUpCa3", PaUpCa3);
  }, [PaUpCa3]);
  
  useEffect(() => {
    localStorage.setItem("PaUpCa4", PaUpCa4);
  }, [PaUpCa4]);

  useEffect(() => {
    localStorage.setItem("PaUpCa5", PaUpCa5);
  }, [PaUpCa5]);

  useEffect(() => {
    localStorage.setItem("PaUpCa6", PaUpCa6);
  }, [PaUpCa6]);

  useEffect(() => {
    localStorage.setItem("PaUpCa7", PaUpCa7);
  }, [PaUpCa7]);
  useEffect(() => {
    localStorage.setItem("PaUpCa8", PaUpCa8);
  }, [PaUpCa8]);
  ...
  const OtLoTeLi1 =  localStorage.getItem('ToOtTeLi1')
  const OtLoTeLi2 =  localStorage.getItem('ToOtTeLi2')
  const OtLoTeLi3 =  localStorage.getItem('ToOtTeLi3')
  const OtLoTeLi4 =  localStorage.getItem('ToOtTeLi4')
  const OtLoTeLi5 =  localStorage.getItem('ToOtTeLi5')
  const OtLoTeLi6 =  localStorage.getItem('ToOtTeLi6')
  const OtLoTeLi7 =  localStorage.getItem('ToOtTeLi7')
  const OtLoTeLi8 =  localStorage.getItem('ToOtTeLi8')

  useEffect(() => {
    localStorage.setItem("OtLoTeLi1", OtLoTeLi1);
  }, [OtLoTeLi1]);

  
useEffect(() => {
  localStorage.setItem("OtLoTeLi2", OtLoTeLi2);
}, [OtLoTeLi2]);


useEffect(() => {
  localStorage.setItem("OtLoTeLi3", OtLoTeLi3);
}, [OtLoTeLi3]);


useEffect(() => {
  localStorage.setItem("OtLoTeLi4", OtLoTeLi4);
}, [OtLoTeLi4]);


useEffect(() => {
  localStorage.setItem("OtLoTeLi5", OtLoTeLi5);
}, [OtLoTeLi5]);


useEffect(() => {
  localStorage.setItem("OtLoTeLi6", OtLoTeLi6);
}, [OtLoTeLi6]);


useEffect(() => {
  localStorage.setItem("OtLoTeLi7", OtLoTeLi7);
}, [OtLoTeLi7]);


useEffect(() => {
  localStorage.setItem("OtLoTeLi8", OtLoTeLi8);
}, [OtLoTeLi8]);
...
useEffect(() => {
  localStorage.setItem("LoTeLi1,",LoTeLi1);
}, [LoTeLi1]);
  ...
  useEffect(() => {
    localStorage.setItem("TeLoIn1", TeLoIn1);
  }, [TeLoIn1]);

  useEffect(() => {
    localStorage.setItem("TeLoIn2", TeLoIn2);
  }, [TeLoIn2]);
  
  useEffect(() => {
    localStorage.setItem("TeLoIn3", TeLoIn3);
  }, [TeLoIn3]);
  
  useEffect(() => {
    localStorage.setItem("TeLoIn4", TeLoIn4);
  }, [TeLoIn4]);
  
  useEffect(() => {
    localStorage.setItem("TeLoIn5", TeLoIn5);
  }, [TeLoIn5]);
  
  useEffect(() => {
    localStorage.setItem("TeLoIn6", TeLoIn6);
  }, [TeLoIn6]);
  ...
  useEffect(() => {
    localStorage.setItem("TeLoOtB1", TeLoOtB1);
  }, [TeLoOtB1]);

  
useEffect(() => {
  localStorage.setItem("TeLoOtB2", TeLoOtB2);
}, [TeLoOtB2]);


useEffect(() => {
  localStorage.setItem("TeLoOtB3", TeLoOtB3);
}, [TeLoOtB3]);


useEffect(() => {
  localStorage.setItem("TeLoOtB4", TeLoOtB4);
}, [TeLoOtB4]);


useEffect(() => {
  localStorage.setItem("TeLoOtB5", TeLoOtB5);
}, [TeLoOtB5]);


useEffect(() => {
  localStorage.setItem("TeLoOtB6", TeLoOtB6);
}, [TeLoOtB6]);


useEffect(() => {
  localStorage.setItem("TeLoOtB7", TeLoOtB7);
}, [TeLoOtB7]);


useEffect(() => {
  localStorage.setItem("TeLoOtB8", TeLoOtB8);
}, [TeLoOtB8]);
...
useEffect(() => {
  localStorage.setItem("OtCuLi1", OtCuLi1);
}, [OtCuLi1]);

  
useEffect(() => {
  localStorage.setItem("OtCuLi2", OtCuLi2);
}, [OtCuLi2]);

  
useEffect(() => {
  localStorage.setItem("OtCuLi3", OtCuLi3);
}, [OtCuLi3]);

  
useEffect(() => {
  localStorage.setItem("OtCuLi4", OtCuLi4);
}, [OtCuLi4]);
  
useEffect(() => {
  localStorage.setItem("OtCuLi5", OtCuLi5);
}, [OtCuLi5]);

  
useEffect(() => {
  localStorage.setItem("OtCuLi6", OtCuLi6);
}, [OtCuLi6]);

  
useEffect(() => {
  localStorage.setItem("OtCuLi7", OtCuLi7);
}, [OtCuLi7]);

  
useEffect(() => {
  localStorage.setItem("OtCuLi8", OtCuLi8);
}, [OtCuLi8]);
  ...
  useEffect(() => {
    localStorage.setItem("WcFrBI1", WcFrBI1);
  }, [WcFrBI1]);


  useEffect(() => {
    localStorage.setItem("WcFrBI2", WcFrBI2);
  }, [WcFrBI2]);
  
  useEffect(() => {
    localStorage.setItem("WcFrBI3", WcFrBI3);
  }, [WcFrBI3]);
  
  useEffect(() => {
    localStorage.setItem("WcFrBI4", WcFrBI4);
  }, [WcFrBI4]);
  
  useEffect(() => {
    localStorage.setItem("WcFrBI5", WcFrBI5);
  }, [WcFrBI5]);
  
  useEffect(() => {
    localStorage.setItem("WcFrBI6", WcFrBI6);
  }, [WcFrBI6]);
  
  useEffect(() => {
    localStorage.setItem("WcFrBI7", WcFrBI7);
  }, [WcFrBI7]);
  
  useEffect(() => {
    localStorage.setItem("WcFrBI8", WcFrBI8);
  }, [WcFrBI8]);
  ...
  useEffect(() => {
    localStorage.setItem("ToAs1", ToAs1);
  }, [ToAs1]);
  
useEffect(() => {
  localStorage.setItem("ToAs2", ToAs2);
}, [ToAs2]);


useEffect(() => {
  localStorage.setItem("ToAs3", ToAs3);
}, [ToAs3]);

useEffect(() => {
  localStorage.setItem("ToAs4", ToAs4);
}, [ToAs4]);


useEffect(() => {
  localStorage.setItem("ToAs5", ToAs5);
}, [ToAs5]);


useEffect(() => {
  localStorage.setItem("ToAs6", ToAs6);
}, [ToAs6]);
  ...
  useEffect(() => {
    localStorage.setItem("ToNca1", ToNca1);
  }, [ToNca1]);

  useEffect(() => {
    localStorage.setItem("ToNca2", ToNca2);
  }, [ToNca2]);
  useEffect(() => {
    localStorage.setItem("ToNca3", ToNca3);
  }, [ToNca3]);
  useEffect(() => {
    localStorage.setItem("ToNca4", ToNca4);
  }, [ToNca4]);
  useEffect(() => {
    localStorage.setItem("ToNca5", ToNca5);
  }, [ToNca5]);
  useEffect(() => {
    localStorage.setItem("ToNca6", ToNca6);
  }, [ToNca6]);
  useEffect(() => {
    localStorage.setItem("ToNca7", ToNca7);
  }, [ToNca7]);
  useEffect(() => {
    localStorage.setItem("ToNca8", ToNca8);
  }, [ToNca8]);
  ...
  useEffect(() => {
    localStorage.setItem("NetFiAs1", NetFiAs1);
  }, [NetFiAs1]);

  useEffect(() => {
    localStorage.setItem("NetFiAs2", NetFiAs2);
  }, [NetFiAs2]);
  
  useEffect(() => {
    localStorage.setItem("NetFiAs3", NetFiAs3);
  }, [NetFiAs3]);
  
  useEffect(() => {
    localStorage.setItem("NetFiAs4", NetFiAs4);
  }, [NetFiAs4]);
  
  useEffect(() => {
    localStorage.setItem("NetFiAs5", NetFiAs5);
  }, [NetFiAs5]);
  
  useEffect(() => {
    localStorage.setItem("NetFiAs6", NetFiAs6);
  }, [NetFiAs6]);
  
  useEffect(() => {
    localStorage.setItem("NetFiAs7", NetFiAs7);
  }, [NetFiAs7]);
  useEffect(() => {
    localStorage.setItem("NetFiAs8", NetFiAs8);
  }, [NetFiAs8]);
  ...
  useEffect(() => {
    localStorage.setItem("GroBlo1", GroBlo1);
  }, [GroBlo1]);

  
useEffect(() => {
  localStorage.setItem("GroBlo2", GroBlo2);
}, [GroBlo2]);


useEffect(() => {
  localStorage.setItem("GroBlo3", GroBlo3);
}, [GroBlo3]);


useEffect(() => {
  localStorage.setItem("GroBlo4", GroBlo4);
}, [GroBlo4]);


useEffect(() => {
  localStorage.setItem("GroBlo5", GroBlo5);
}, [GroBlo5]);


useEffect(() => {
  localStorage.setItem("GroBlo6", GroBlo6);
}, [GroBlo6]);


useEffect(() => {
  localStorage.setItem("GroBlo7", GroBlo7);
}, [GroBlo7]);


useEffect(() => {
  localStorage.setItem("GroBlo8", GroBlo8);
}, [GroBlo8]);
...
const[CaWoPr8,setCaWoPr8] = useState('');
  ...
  useEffect(() => {
    localStorage.setItem("conSuSp1", conSuSp1);
  }, [conSuSp1]);
  useEffect(() => {
    localStorage.setItem("conSuSp2", conSuSp2);
  }, [conSuSp2]);
  
  useEffect(() => {
    localStorage.setItem("conSuSp3", conSuSp3);
  }, [conSuSp3]);
  useEffect(() => {
    localStorage.setItem("conSuSp4", conSuSp4);
  }, [conSuSp4]);
  useEffect(() => {
    localStorage.setItem("conSuSp5", conSuSp5);
  }, [conSuSp5]);
  useEffect(() => {
    localStorage.setItem("conSuSp6", conSuSp6);
  }, [conSuSp6]);
  useEffect(() => {
    localStorage.setItem("conSuSp7", conSuSp7);
  }, [conSuSp7]);
  useEffect(() => {
    localStorage.setItem("conSuSp8", conSuSp8);
  }, [conSuSp8]);
...
useEffect(() => {
  localStorage.setItem("TrDeb1", TrDeb1);
}, [TrDeb1]);
useEffect(() => {
  localStorage.setItem("TrDeb2", TrDeb2);
}, [TrDeb2]);

useEffect(() => {
  localStorage.setItem("TrDeb3", TrDeb3);
}, [TrDeb3]);

useEffect(() => {
  localStorage.setItem("TrDeb4", TrDeb4);
}, [TrDeb4]);

useEffect(() => {
  localStorage.setItem("TrDeb5", TrDeb5);
}, [TrDeb5]);

useEffect(() => {
  localStorage.setItem("TrDeb6", TrDeb6);
}, [TrDeb6]);
useEffect(() => {
  localStorage.setItem("TrDeb7", TrDeb7);
}, [TrDeb7]);
useEffect(() => {
  localStorage.setItem("TrDeb8", TrDeb8);
}, [TrDeb8]);
  ...
  useEffect(() => {
    localStorage.setItem("ToCuAs1", display);
  }, [display]);

  useEffect(() => {
    localStorage.setItem("ToCuAs2", ToCuAs2);
  }, [ToCuAs2]);
  
  useEffect(() => {
    localStorage.setItem("ToCuAs3", ToCuAs3);
  }, [ToCuAs3]);
  useEffect(() => {
    localStorage.setItem("ToCuAs4", ToCuAs4);
  }, [ToCuAs4]);
  
  useEffect(() => {
    localStorage.setItem("ToCuAs5", ToCuAs5);
  }, [ToCuAs5]);
  
  useEffect(() => {
    localStorage.setItem("ToCuAs6", ToCuAs6);
  }, [ToCuAs6]);
  
  useEffect(() => {
    localStorage.setItem("ToCuAs7", ToCuAs7);
  }, [ToCuAs7]);
  
  useEffect(() => {
    localStorage.setItem("ToCuAs8", ToCuAs8);
  }, [ToCuAs8]);
...
useEffect(() => {
  localStorage.setItem("NetWo1", NetWo1);
}, [NetWo1]);

useEffect(() => {
  localStorage.setItem("NetWo2", NetWo2);
}, [NetWo2]);


useEffect(() => {
  localStorage.setItem("NetWo3", NetWo3);
}, [NetWo3]);

useEffect(() => {
  localStorage.setItem("NetWo4", NetWo4);
}, [NetWo4]);

useEffect(() => {
  localStorage.setItem("NetWo5", NetWo5);
}, [NetWo5]);

useEffect(() => {
  localStorage.setItem("NetWo6", NetWo6);
}, [NetWo6]);

useEffect(() => {
  localStorage.setItem("NetWo7", NetWo7);
}, [NetWo7]);

useEffect(() => {
  localStorage.setItem("NetWo8", NetWo8);
}, [NetWo8]);
...
useEffect(() => {
  localStorage.setItem("ToIa1", ToIa1);
}, [ToIa1]);

useEffect(() => {
  localStorage.setItem("ToIa2", ToIa2);
}, [ToIa2]);

useEffect(() => {
  localStorage.setItem("ToIa3", ToIa3);
}, [ToIa3]);

useEffect(() => {
  localStorage.setItem("ToIa4", ToIa4);
}, [ToIa4]);

useEffect(() => {
  localStorage.setItem("ToIa5", ToIa5);
}, [ToIa5]);

useEffect(() => {
  localStorage.setItem("ToIa6", ToIa6);
}, [ToIa6]);

useEffect(() => {
  localStorage.setItem("ToIa7", ToIa7);
}, [ToIa7]);

useEffect(() => {
  localStorage.setItem("ToIa8", ToIa8);
}, [ToIa8]);
...
useEffect(() => {
  localStorage.setItem("InLoTo1", InLoTo1);
}, [InLoTo1]);


useEffect(() => {
  localStorage.setItem("InLoTo2", InLoTo2);
}, [InLoTo2]);


useEffect(() => {
  localStorage.setItem("InLoTo3", InLoTo3);
}, [InLoTo3]);


useEffect(() => {
  localStorage.setItem("InLoTo4", InLoTo4);
}, [InLoTo4]);


useEffect(() => {
  localStorage.setItem("InLoTo5", InLoTo5);
}, [InLoTo5]);


useEffect(() => {
  localStorage.setItem("InLoTo6", InLoTo6);
}, [InLoTo6]);


useEffect(() => {
  localStorage.setItem("InLoTo7", InLoTo7);
}, [InLoTo7]);


useEffect(() => {
  localStorage.setItem("InLoTo8", InLoTo8);
}, [InLoTo8]);
...
useEffect(() => {
  localStorage.setItem("ToCuLi1", ToCuLi1);
}, [ToCuLi1]);
useEffect(() => {
  localStorage.setItem("ToCuLi2", ToCuLi2);
}, [ToCuLi2]);

useEffect(() => {
  localStorage.setItem("ToCuLi3", ToCuLi3);
}, [ToCuLi3]);

useEffect(() => {
  localStorage.setItem("ToCuLi4", ToCuLi4);
}, [ToCuLi4]);

useEffect(() => {
  localStorage.setItem("ToCuLi5", ToCuLi5);
}, [ToCuLi5]);

useEffect(() => {
  localStorage.setItem("ToCuLi6", ToCuLi6);
}, [ToCuLi6]);

useEffect(() => {
  localStorage.setItem("ToCuLi7", ToCuLi7);
}, [ToCuLi7]);

useEffect(() => {
  localStorage.setItem("ToCuLi8", ToCuLi8);
}, [ToCuLi8]);
...
useEffect(() => {
  localStorage.setItem("ToOuLi1", ToOuLi1);
}, [ToOuLi1]);

useEffect(() => {
  localStorage.setItem("ToOuLi2", ToOuLi2);
}, [ToOuLi2]);

useEffect(() => {
  localStorage.setItem("ToOuLi3", ToOuLi3);
}, [ToOuLi3]);

useEffect(() => {
  localStorage.setItem("ToOuLi4", ToOuLi4);
}, [ToOuLi4]);

useEffect(() => {
  localStorage.setItem("ToOuLi5", ToOuLi5);
}, [ToOuLi5]);

useEffect(() => {
  localStorage.setItem("ToOuLi6", ToOuLi6);
}, [ToOuLi6]);

useEffect(() => {
  localStorage.setItem("ToOuLi7", ToOuLi7);
}, [ToOuLi7]);

useEffect(() => {
  localStorage.setItem("ToOuLi8", ToOuLi8);
}, [ToOuLi8]);
...
useEffect(() => {
  localStorage.setItem("TeLoIo1", TeLoIo1);
}, [TeLoIo1]);


useEffect(() => {
  localStorage.setItem("TeLoIo2", TeLoIo2);
}, [TeLoIo2]);


useEffect(() => {
  localStorage.setItem("TeLoIo3", TeLoIo3);
}, [TeLoIo3]);


useEffect(() => {
  localStorage.setItem("TeLoIo4", TeLoIo4);
}, [TeLoIo4]);


useEffect(() => {
  localStorage.setItem("TeLoIo5", TeLoIo5);
}, [TeLoIo5]);


useEffect(() => {
  localStorage.setItem("TeLoIo6", TeLoIo6);
}, [TeLoIo6]);


useEffect(() => {
  localStorage.setItem("TeLoIo7", TeLoIo7);
}, [TeLoIo7]);

useEffect(() => {
  localStorage.setItem("TeLoIo8", TeLoIo8);
}, [TeLoIo8]);
...
useEffect(() => {
  localStorage.setItem("wcBrIob1", wcBrIob1);
}, [wcBrIob1]);


useEffect(() => {
localStorage.setItem("wcBrIob2", wcBrIob2);
}, [wcBrIob2]);


useEffect(() => {
localStorage.setItem("wcBrIob3", wcBrIob3);
}, [wcBrIob3]);


useEffect(() => {
localStorage.setItem("wcBrIob4", wcBrIob4);
}, [wcBrIob4]);


useEffect(() => {
localStorage.setItem("wcBrIob5", wcBrIob5);
}, [wcBrIob5]);


useEffect(() => {
localStorage.setItem("wcBrIob6", wcBrIob6);
}, [wcBrIob6]);


useEffect(() => {
localStorage.setItem("wcBrIob7", wcBrIob7);
}, [wcBrIob7]);


useEffect(() => {
localStorage.setItem("wcBrIob8", wcBrIob8);
}, [wcBrIob8]);
...
useEffect(() => {
  localStorage.setItem("SunCrTr1", SunCrTr1);
  }, [SunCrTr1]);
  useEffect(() => {
    localStorage.setItem("SunCrTr2", SunCrTr2);
  }, [SunCrTr2]);
  
  useEffect(() => {
    localStorage.setItem("SunCrTr3", SunCrTr3);
  }, [SunCrTr3]);
  
  useEffect(() => {
    localStorage.setItem("SunCrTr4", SunCrTr4);
  }, [SunCrTr4]);
  
  useEffect(() => {
    localStorage.setItem("SunCrTr5", SunCrTr5);
  }, [SunCrTr5]);
  
  useEffect(() => {
    localStorage.setItem("SunCrTr6", SunCrTr6);
  }, [SunCrTr6]);
  
  useEffect(() => {
    localStorage.setItem("SunCrTr7", SunCrTr7);
  }, [SunCrTr7]);
  useEffect(() => {
    localStorage.setItem("SunCrTr8", SunCrTr8);
  }, [SunCrTr8]);
  ...
  useEffect(() => {
    localStorage.setItem("LoTeLi2,",LoTeLi2);
  }, [LoTeLi2]);
  
  useEffect(() => {
    localStorage.setItem("LoTeLi3,",LoTeLi3);
  }, [LoTeLi3]);
  
  
  useEffect(() => {
    localStorage.setItem("LoTeLi4,",LoTeLi4);
  }, [LoTeLi4]);
  
  
  useEffect(() => {
    localStorage.setItem("LoTeLi5,",LoTeLi5);
  }, [LoTeLi5]);
  
  
  useEffect(() => {
    localStorage.setItem("LoTeLi6,",LoTeLi6);
  }, [LoTeLi6]);
  
  
  useEffect(() => {
    localStorage.setItem("LoTeLi7,",LoTeLi7);
  }, [LoTeLi7]);
  
  
  useEffect(() => {
    localStorage.setItem("LoTeLi8,",LoTeLi8);
  }, [LoTeLi8]);
