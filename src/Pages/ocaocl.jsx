...
const Ocaocl = () => {
  ...
  const[OthTerLib1,setOthTerLib1]=useState('');
  const[OthTerLib2,setOthTerLib2]=useState('');
  const[OthTerLib3,setOthTerLib3]=useState('');
  const[OthTerLib4,setOthTerLib4]=useState('');
  const[OthTerLib5,setOthTerLib5]=useState('');
  const[OthTerLib6,setOthTerLib6]=useState('');
  const[OthTerLib7,setOthTerLib7]=useState('');
  const[OthTerLib8,setOthTerLib8]=useState('');

  
  useEffect(() => {
    localStorage.setItem("OthTerLib1", OthTerLib1);
  }, [OthTerLib1]);
  useEffect(() => {
    localStorage.setItem("OthTerLib2", OthTerLib2);
  }, [OthTerLib2]);
  
  useEffect(() => {
    localStorage.setItem("OthTerLib3", OthTerLib3);
  }, [OthTerLib3]);
  useEffect(() => {
    localStorage.setItem("OthTerLib4", OthTerLib4);
  }, [OthTerLib4]);
  useEffect(() => {
    localStorage.setItem("OthTerLib5", OthTerLib5);
  }, [OthTerLib5]);
  useEffect(() => {
    localStorage.setItem("OthTerLib6", OthTerLib6);
  }, [OthTerLib6]);
  useEffect(() => {
    localStorage.setItem("OthTerLib7", OthTerLib7);
  }, [OthTerLib7]);
  useEffect(() => {
    localStorage.setItem("OthTerLib8", OthTerLib8);
  }, [OthTerLib8]);
...
useEffect(() => {
  localStorage.setItem("ToOtTeLi1", ToOtTeLi1);
}, [ToOtTeLi1]);

useEffect(() => {
  localStorage.setItem("ToOtTeLi2", ToOtTeLi2);
}, [ToOtTeLi2]);

useEffect(() => {
  localStorage.setItem("ToOtTeLi3", ToOtTeLi3);
}, [ToOtTeLi3]);

useEffect(() => {
  localStorage.setItem("ToOtTeLi4", ToOtTeLi4);
}, [ToOtTeLi4]);

useEffect(() => {
  localStorage.setItem("ToOtTeLi5", ToOtTeLi5);
}, [ToOtTeLi5]);

useEffect(() => {
  localStorage.setItem("ToOtTeLi6", ToOtTeLi6);
}, [ToOtTeLi6]);

useEffect(() => {
  localStorage.setItem("ToOtTeLi7", ToOtTeLi7);
}, [ToOtTeLi7]);
useEffect(() => {
  localStorage.setItem("ToOtTeLi8", ToOtTeLi8);
}, [ToOtTeLi8]);
  ...
  useEffect(() => {
    localStorage.setItem("RevRes1", RevRes1);
  }, [RevRes1]);

  useEffect(() => {
    localStorage.setItem("RevRes2", RevRes2);
  }, [RevRes2]);
  
  useEffect(() => {
    localStorage.setItem("RevRes3", RevRes3);
  }, [RevRes3]);
  
  useEffect(() => {
    localStorage.setItem("RevRes4", RevRes4);
  }, [RevRes4]);
  
  useEffect(() => {
    localStorage.setItem("RevRes5", RevRes5);
  }, [RevRes5]);
  
  useEffect(() => {
    localStorage.setItem("RevRes6", RevRes6);
  }, [RevRes6]);
  
  useEffect(() => {
    localStorage.setItem("RevRes7", RevRes7);
  }, [RevRes7]);
  
  useEffect(() => {
    localStorage.setItem("RevRes8", RevRes8);
  }, [RevRes8]);
  ...
  useEffect(() => {
    localStorage.setItem("ToOtCuLi1", ToOtCuLi1);
  }, [ToOtCuLi1]);
  useEffect(() => {
    localStorage.setItem("ToOtCuLi2", ToOtCuLi2);
  }, [ToOtCuLi2]);
  useEffect(() => {
    localStorage.setItem("ToOtCuLi3", ToOtCuLi3);
  }, [ToOtCuLi3]);
  useEffect(() => {
    localStorage.setItem("ToOtCuLi4", ToOtCuLi4);
  }, [ToOtCuLi4]);
  useEffect(() => {
    localStorage.setItem("ToOtCuLi5", ToOtCuLi5);
  }, [ToOtCuLi5]);
  useEffect(() => {
    localStorage.setItem("ToOtCuLi6", ToOtCuLi6);
  }, [ToOtCuLi6]);
  useEffect(() => {
    localStorage.setItem("ToOtCuLi7", ToOtCuLi7);
  }, [ToOtCuLi7]);
  useEffect(() => {
    localStorage.setItem("ToOtCuLi8", ToOtCuLi8);
  }, [ToOtCuLi8]);
  ...
  useEffect(() => {
    localStorage.setItem("TlduBa1", TlduBa1);
  }, [TlduBa1]);
  useEffect(() => {
    localStorage.setItem("TlduBa2", TlduBa2);
  }, [TlduBa2]);
  
  useEffect(() => {
    localStorage.setItem("TlduBa3", TlduBa3);
  }, [TlduBa3]);
  
  useEffect(() => {
    localStorage.setItem("TlduBa4", TlduBa4);
  }, [TlduBa4]);
  useEffect(() => {
    localStorage.setItem("TlduBa5", TlduBa5);
  }, [TlduBa5]);
  useEffect(() => {
    localStorage.setItem("TlduBa6", TlduBa6);
  }, [TlduBa6]);
  useEffect(() => {
    localStorage.setItem("TlduBa7", TlduBa7);
  }, [TlduBa7]);
  useEffect(() => {
    localStorage.setItem("TlduBa8", TlduBa8);
  }, [TlduBa8]);
  ...
  useEffect(() => {
    localStorage.setItem("SunDeb1", SunDeb1);
  }, [SunDeb1]);
  ...
  useEffect(() => {
    localStorage.setItem("ToOtCuAs1", ToOtCuAs1);
  }, [ToOtCuAs1]);

  useEffect(() => {
    localStorage.setItem("ToOtCuAs2", ToOtCuAs2);
  }, [ToOtCuAs2]);
  
  useEffect(() => {
    localStorage.setItem("ToOtCuAs3", ToOtCuAs3);
  }, [ToOtCuAs3]);
  
  useEffect(() => {
    localStorage.setItem("ToOtCuAs4", ToOtCuAs4);
  }, [ToOtCuAs4]);
  
  useEffect(() => {
    localStorage.setItem("ToOtCuAs5", ToOtCuAs5);
  }, [ToOtCuAs5]);
  
  useEffect(() => {
    localStorage.setItem("ToOtCuAs6", ToOtCuAs6);
  }, [ToOtCuAs6]);
  
  useEffect(() => {
    localStorage.setItem("ToOtCuAs7", ToOtCuAs7);
  }, [ToOtCuAs7]);
  
  useEffect(() => {
    localStorage.setItem("ToOtCuAs8", ToOtCuAs8);
  }, [ToOtCuAs8]);
...
useEffect(() => {
  localStorage.setItem("UnLoPr1", UnLoPr1);
}, [UnLoPr1]);


useEffect(() => {
  localStorage.setItem("UnLoPr2", UnLoPr2);
}, [UnLoPr2]);


useEffect(() => {
  localStorage.setItem("UnLoPr3", UnLoPr3);
}, [UnLoPr3]);


useEffect(() => {
  localStorage.setItem("UnLoPr4", UnLoPr4);
}, [UnLoPr4]);


useEffect(() => {
  localStorage.setItem("UnLoPr5", UnLoPr5);
}, [UnLoPr5]);


useEffect(() => {
  localStorage.setItem("UnLoPr6", UnLoPr6);
}, [UnLoPr6]);


useEffect(() => {
  localStorage.setItem("UnLoPr7", UnLoPr7);
}, [UnLoPr7]);


useEffect(() => {
  localStorage.setItem("UnLoPr8", UnLoPr8);
}, [UnLoPr8]);
          ...
          <Row >
            ...
            <Col className=" border border-solid  flex items-center justify-center">
              <input
                ...
                type="number"
                value={OthTerLib1}
                onChange={(e) => setOthTerLib1(e.target.value)}
              />
            </Col>
            <Col className=" border border-solid  flex items-center justify-center">
              <input
                ...
                type="number"
                value={OthTerLib2}
                onChange={(e) => setOthTerLib2(e.target.value)}
              />
            </Col>
            <Col className=" border border-solid  flex items-center justify-center">
              <input
                ...
                type="number"
                value={OthTerLib3}
                onChange={(e) => setOthTerLib3(e.target.value)}
              />
            </Col>
            <Col className=" border border-solid  flex items-center justify-center">
              <input
                ...
                type="number"
                value={OthTerLib4}
                onChange={(e) => setOthTerLib4(e.target.value)}
              />
            </Col>
            <Col className=" border border-solid  flex items-center justify-center">
              <input
                ...
                type="number"
                value={OthTerLib5}
                onChange={(e) => setOthTerLib5(e.target.value)}
              />
            </Col>
            <Col className=" border border-solid  flex items-center justify-center">
              <input
                ...
                type="number"
                value={OthTerLib6}
                onChange={(e) => setOthTerLib6(e.target.value)}
              />
            </Col>
            <Col className=" border border-solid  flex items-center justify-center">
              <input
                ...
                type="number"
                value={OthTerLib7}
                onChange={(e) => setOthTerLib7(e.target.value)}
              />
            </Col>
            <Col className=" border border-solid  flex items-center justify-center">
              <input
                ...
                type="number"
                value={OthTerLib8}
                onChange={(e) => setOthTerLib8(e.target.value)}
              />
            </Col>
          </Row>
          ...
          <Row>
            ...
            <Col className=" border border-solid  flex items-center justify-center">
              <input
                ...
                type="number"
                value={RevRes4}
                onChange={(e) => setRevRes4(e.target.value)}
              />
            </Col>
